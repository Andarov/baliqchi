        ...
        <div className='py-12 max-800:py-10 max-550:pt-6'>
            <div className='flex gap-5 container max-550:flex-col'>
                <div className="space-y-5">
                    ...
                    <h1 className='mb-5'>Davlat dasturlari</h1>

                    <strong className='block !mb-8 uppercase'>2022 — 2026-YILLARGA MO‘LJALLANGAN YANGI O‘ZBEKISTONNING TARAQQIYOT STRATEGIYASINI “INSONGA E’TIBOR VA SIFATLI TA’LIM YILI”DA AMALGA OSHIRISHGA OID DAVLAT DASTURI TO‘G‘RISIDA </strong>


                    <p>2022 — 2026-yillarga mo‘ljallangan Yangi O‘zbekistonning taraqqiyot strategiyasi hamda O‘zbekiston Respublikasi Prezidentining Oliy Majlis va O‘zbekiston xalqiga Murojaatnomasida belgilangan vazifalarga muvofiq aholining hayot darajasini yanada yuksaltirish, ta’lim sifatini ilg‘or xalqaro standartlarga muvofiqlashtirish, barqaror iqtisodiy o‘sishga erishish hamda kambag‘allikni qisqartirish borasidagi islohotlarimizni yangi bosqichga olib chiqish maqsadida:</p>


                    <p>1. Jamoatchiligimiz va xalqimiz bilan keng muhokamalarda bildirilgan takliflar asosida ishlab chiqilgan 2022 — 2026-yillarga mo‘ljallangan Yangi O‘zbekistonning taraqqiyot strategiyasini “Insonga e’tibor va sifatli ta’lim yili”da amalga oshirishga oid davlat dasturi (keyingi o‘rinlarda — Davlat dasturi) ilovaga muvofiq tasdiqlansin. <br />
                        Vazirlar Mahkamasi, Qoraqalpog‘iston Respublikasi Vazirlar Kengashi, viloyatlar va Toshkent shahri hokimliklari Davlat dasturi ijrosini samarali, qat’iy tartib-intizom asosida tashkil etib, 10 kun muddatda har bir tuman, shahar va mahalla kesimida amaliy chora-tadbirlarni belgilasin hamda keng jamoatchilik va ommaviy axborot vositalari ishtirokida muntazam ravishda mas’ul shaxslarning hisobotini eshitib borsin. <br />
                        Oliy Majlis palatalari va mahalliy Kengashlarga Davlat dasturining bajarilishini tumanlar, shaharlar va mahallalarga borib o‘rganish, mas’ul davlat organlari rahbarlarining hisobotlarini eshitib borish tavsiya etilsin.</p>


                    <p>2. Xalqimizning og‘irini yengil qilish, aholi uchun qo‘shimcha qulayliklar yaratish va ularning xarajatlarini tejash maqsadida, 2023-yil 1-iyuldan boshlab: <br /><br />
                        (a) barcha davlat organlari va tashkilotlarida “Aholi va tadbirkorlarga servis sifatini oshirish” chora-tadbirlari belgilansin. <br /><br />
                        Vazirlar va boshqa mustaqil ijro etuvchi hokimiyat organlari rahbarlari 15 kun muddatda o‘z tizimida masofadan turib, shu jumladan mobil ilovalar orqali ko‘rsatiladigan davlat xizmatlarini ko‘paytirish, undiriladigan to‘lovlar miqdorini kamaytirish, talab qilinadigan ortiqcha hujjatlarni bekor qilish, ko‘rib chiqish jarayonlari va muddatlarini keskin qisqartirish, shaffoflikni oshirish, aholi va tadbirkorlar bilan doimiy muloqot maydonchalarini tashkil etish, xodimlarning muomala madaniyatini yuksaltirish, tezkor va sifatli xizmat ko‘rsatishga o‘qitish bo‘yicha tadbirlar dasturini tasdiqlab, aholi va tadbirkorlarga e’lon qilsin; <br /><br />
                        (b) davlat xizmatlari markazlari orqali ko‘rsatiladigan davlat xizmatlari soni 300 taga, Yagona interaktiv davlat xizmatlari portali orqali ko‘rsatiladigan xizmatlar soni esa 570 taga yetkazilsin; <br /><br />
                        (v) aholining ijtimoiy himoyaga muhtoj qatlamlari (nogironligi bo‘lgan shaxslar, og‘ir bemorlar, keksalar va boshqalar)ga migratsiya va fuqarolikni rasmiylashtirish sohasidagi davlat xizmatlarini doimiy yashash yoki vaqtincha turgan joyiga chiqish orqali ko‘rsatilgan xizmat uchun qo‘shimcha to‘lov undirilmagan holda ko‘rsatish yo‘lga qo‘yilsin; <br /><br />
                        (g) elektr, gaz va suv sarfi hisoblagichlarini qiyoslashdan o‘tkazish bo‘yicha davlat xizmatlarini proaktiv tarzda ko‘rsatish (fuqaro murojaatini kutmasdan, xizmat ko‘rsatuvchi tashkilotning o‘z tashabbusi bilan) taklifini yuborish yo‘lga qo‘yilsin.</p>

                    <p>3. 2023-yil 1-sentabrdan boshlab aholi va tadbirkorlik subyektlariga subsidiya ajratish bilan bog‘liq barcha xizmatlar bosqichma-bosqich “Aholi va tadbirkorlik subyektlariga subsidiya ajratishning yagona elektron platforma”siga o‘tkazilsin hamda subsidiyalarni ajratishning maqsadga muvofiqligini elektron platforma orqali onlayn tekshirish tizimi yo‘lga qo‘yilsin. <br /><br />
                        Bunda, subsidiyalar ajratish to‘g‘risidagi arizalarni Yagona interaktiv davlat xizmatlari portali orqali yoki istalgan tuman (shahar) davlat xizmatlari markazlari orqali topshirish imkoniyatini yaratish hamda ortiqcha byurokratik to‘siqlar va boshqa korrupsiyaviy omillarni bartaraf etish ta’minlansin.</p>

                    <p className='line-clamp-2'>4. Fuqarolarning pensiya ta’minotini yaxshilash va pensionerlarni qo‘llab-quvvatlash maqsadida, 2024-yil 1-yanvardan boshlab pensionerga hisoblangan, lekin o‘z vaqtida olinmagan pensiyani to‘lash muddati 12 oydan 24 oyga uzaytirilsin.</p>

                    <a href="https://lex.uz/docs/-6396146" target='_blank' className="inline-block py-3 px-6 rounded-full border-gray-400 border">Ba'tafsil o'qish</a>
                </div>
