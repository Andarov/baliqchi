        ...
        <div className="flex gap-5 container max-800:flex-col">
          <div className="space-y-4">
            ...
            <strong className="block mb-8">
              Quyidagi faylni yuklab olish orqali Baliqchi tumanining rasmiy
              statistik ma'lumotlarini ko'rishingiz mumkin. Faylni yuklab olish
              uchun "FAYLNI YUKLAB OLISH" tugmasini bosing
            </strong>

            <a
              href='https://firebasestorage.googleapis.com/v0/b/baliqchi-admin.appspot.com/o/doc%2Fstatistika.docx?alt=media&token=18e581db-7eeb-4f25-8cf5-1e09d8de5bc1'
              download
              className="inline-block py-3 px-6 rounded-full border-gray-400 border"
            >
              Faylni yuklab olish
            </a>
          </div>
