    ...
    return (
        <div className='py-12 max-800:py-10 max-550:pt-6'>
            ...
            <div onClick={() => {
                ...
                className={`${openModal ? 'flex' : 'hidden'} items-center justify-center fixed w-full min-h-screen top-0 right-0 bg-black bg-opacity-70 z-20`}>
                <img src={clickedImg} alt="" className="w-[950px] h-full max-h-[600px] object-cover max-950:w-full" />
            </div>
        </div>
    );
};
