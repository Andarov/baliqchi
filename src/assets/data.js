...
export const news = [
  {
    id: randomId(),
    title:
      "Baliqchi tumani yoshlari uchun maxsus 'Ibrat farzandlari marafoni' tashkil etildi.",
    image: [ibrat],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Baliqchi tumani Chinobod shaharchasi markazida mehnat yarmarkasi o‘tkazildi.",
    image: [yarmarka],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Voleybol bo‘yicha viloyat ichki ishlar boshqarmasi boshlig‘i sovrini uchun xotin - qizlar o‘rtasida musobaqa bo‘lib o‘tdi.",
  ...
  },
  {
    id: randomId(),
    title:
      "'Yashirin iqtisodiyotga barham berish, biznesni soyadan olib chiqish vs teng raqobat muhitini yaratish borasida' chora tadbirlar belgilab uning amaliy ijrosiga kirishildi",
    image: [prokuror],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Baliqchi tumani maktabgacha va maktab talimi bo'limi binosida matbuot anjumani bo'lib o'tdi",
    image: [maktab],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Mahallalarda tadbirkorlikni rivojlantirish, bandlikni taminlash, jinoyatchilik va huquqbuzarlikni oldini olish dolzarb vazifa",
    image: [bandlik],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Baliqchi tumani faollar zalida 'Inson' ijtimoiy xizmatlar markazining faoliyat yo'nalishlari va boshqa bir qator masalalar bo'yicha yig'ilish bo'lib o'tdi",
    image: [inson],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Xalq deputatlari Baliqchi tumani Kengashining navbatdagi 6-chaqiriq 42-sessiyasi bo'lib o'tdi",
    image: [sessiya],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "O'zbekiston Respublikasi Prezidenti parlamentlararo munosbatlarni yanada rivojlantirish muhimligini qayd etdi",
    image: [china],
    description: [
  ...
  },
  {
    id: randomId(),
    title:
      "Baliqchi tumani hokimligi faollar zalida hokim va yoshlar uchrashuvi o'tkazildi",
    subTitle:
  ...
  {
    id: randomId(),
    title: "Shuhratbek Abdurahmonov O'zbekiston-Xitoy mintaqalararo forumida",
    subTitle:
...
// docs
import adliyaPdf from "./docs/adliya.pdf";
import iibPdf from "./docs/iib.pdf";
import mibPdf from "./docs/mib.pdf";
import qabulxonaPdf from "./docs/qabulxona.pdf";
import zamiibPdf from "./docs/zamiib.pdf";

export { adliyaPdf, iibPdf, mibPdf, qabulxonaPdf, zamiibPdf };
...
export const links = [
  ...
  },
  {
    ...
    title: "Lex.uz",
    description:
      "Oʻzbekiston Respublikasi Qonun hujjatlari maʼlumotlari milliy bazasi",
    url: "https://lex.uz/uz/",
  },
  {
    id: 3,
