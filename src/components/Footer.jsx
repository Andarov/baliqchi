        ...
        <div className="flex items-center justify-between py-5">
          ...
          <Link to="/" className="flex gap-2 items-center text-gray-300">
            <img
              src={coatOfArms}
              alt="flag"
              className="w-14 h-14 max-550:w-12 max-550:h-12 max-[350px]:hidden"
            />
            <img
              src={flag}
              alt="flag"
              className="w-[3px] h-12 rounded-[1px] max-550:h-8 max-[350px]:hidden"
            />
            <h1 className="flex flex-col">
              <strong className="font-bold text-lg max-550:text-lg text-white">
                Baliqchi tuman hokimligi
              </strong>
        ...
        <div className="w-full max-w-[1280px] px-5 mx-auto py-5">
          <div className="flex gap-10 justify-between max-950:flex-col-reverse">
            <ul className="grid grid-cols-3 gap-6 text-white max-[768px]:grid-cols-2 max-550:grid-cols-1 max-550:gap-10">
              <li>
                <h3 className="font-semibold text-lg leading-normal mb-4 text-white">
                  Hokimiyat haqida
                </h3>
            ...
            <div className="flex flex-col max-950:flex-row gap-5 text-white max-550:flex-col">
              <div className="rounded-xl p-3 bg-[#2E4374]">
                <p className="font-medium text-base">
                  Manzil: Anidijon viloyati, Baliqchi <br /> tumani, Baliqchi
                  shox ko'chasi 1-uy
                </p>
              </div>
              ...
              <div className="rounded-xl p-3 bg-[#2E4374]">
                <p className="font-medium text-base">
                  Saytda xatolikni topdingizmi? <br /> Operatorlarimiz bilan
                  bog'laning
                </p>
              </div>
            </div>
        ...
        <div className="text-white py-5">
          <div className="flex items-center justify-center">
            <p className="font-medium text-base leading-normal">
              Baliqchi 2024 BARCHA HUQUQLAR QONUN BILAN HIMOYALANGAN.
            </p>
          </div>
        </div>
      </div>
